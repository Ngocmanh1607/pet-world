...
export const productService = {
  ...
  getById: async id => {
    try {
      const response = await axiosInstance.get(API_ENDPOINTS.PRODUCTS.GET_DETAIL(id))
      return response.data
    } catch (error) {
  ...
  create: async data => {
    try {
      const response = await axiosInstance.post(API_ENDPOINTS.PRODUCTS.CREATE, data, withRetry())
      return response.data
    } catch (error) {
  ...
  update: async (id, data) => {
    try {
      const response = await axiosInstance.put(API_ENDPOINTS.PRODUCTS.UPDATE(id), data, withRetry())
      return response.data
    } catch (error) {
  ...
  delete: async id => {
    try {
      await axiosInstance.delete(API_ENDPOINTS.PRODUCTS.DELETE(id), withRetry())
    } catch (error) {
...
export const orderService = {
  ...
  getById: async id => {
    try {
      const response = await axiosInstance.get(API_ENDPOINTS.ORDERS.GET_DETAIL(id))
      return response.data
    } catch (error) {
  ...
  update: async (id, data) => {
    try {
      const response = await axiosInstance.put(API_ENDPOINTS.ORDERS.UPDATE(id), data, withRetry())
      return response.data
    } catch (error) {
  ...
  getStatistics: async () => {
    try {
      const response = await axiosInstance.get(API_ENDPOINTS.ORDERS.GET_STATISTICS)
      return response.data
    } catch (error) {
  ...
  getMonthlyRevenue: async () => {
    try {
      const response = await axiosInstance.get(API_ENDPOINTS.ORDERS.GET_MONTHLY_REVENUE)
      return response.data
    } catch (error) {
...
export const customerService = {
  getCount: async () => {
    try {
      const response = await axiosInstance.get(API_ENDPOINTS.CUSTOMERS.GET_COUNT)
      return response.data
    } catch (error) {
  ...
  getAddress: async () => {
    try {
      const response = await axiosInstance.get(API_ENDPOINTS.CUSTOMERS.GET_ADDRESS)
      return response.data
    } catch (error) {
  ...
  saveAddress: async addressData => {
    try {
      const response = await axiosInstance.post(API_ENDPOINTS.CUSTOMERS.SAVE_ADDRESS, addressData)
      return response.data
    } catch (error) {
  ...
  deleteAddress: async () => {
    try {
      const response = await axiosInstance.delete(API_ENDPOINTS.CUSTOMERS.DELETE_ADDRESS)
      return response.data
    } catch (error) {
      handleError(error, 'Không thể tải địa chỉ')
    }
...
export const promotionService = {
  checkCode: async code => {
    try {
      const response = await axiosInstance.get(API_ENDPOINTS.PROMOTIONS.CHECK_CODE(code))
      return response.data
    } catch (error) {
